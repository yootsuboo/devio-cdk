  ...
  createResources(scope: cdk.Construct) {
    this.public1a = new CfnSubnet(scope, "SubnetPublic1a", {
      ...
      tags: [
        {
          key: "Name",
          value: this.createResourceName(scope, "subnet-public-1a"),
        },
      ],
    });
    this.public1c = new CfnSubnet(scope, "SubnetPublic1c", {
      ...
      tags: [
        {
          key: "Name",
          value: this.createResourceName(scope, "subnet-public-1c"),
        },
      ],
    });
    this.app1a = new CfnSubnet(scope, "SubnetApp1a", {
      ...
      availabilityZone: "ap-northeast-1a",
      tags: [
        { key: "Name", value: this.createResourceName(scope, "subnet-app-1a") },
      ],
    });
    this.app1c = new CfnSubnet(scope, "SubnetApp1c", {
      ...
      availabilityZone: "ap-northeast-1c",
      tags: [
        { key: "Name", value: this.createResourceName(scope, "subnet-app-1c") },
      ],
    });
    this.db1a = new CfnSubnet(scope, "SubnetDb1a", {
      ...
      availabilityZone: "ap-northeast-1a",
      tags: [
        { key: "Name", value: this.createResourceName(scope, "subnet-db-1a") },
      ],
    });
    this.db1c = new CfnSubnet(scope, "SubnetDb1c", {
      ...
      availabilityZone: "ap-northeast-1c",
      tags: [
        { key: "Name", value: this.createResourceName(scope, "subnet-db-1c") },
      ],
    });
  }
}
