...
test("Subnet", () => {
  ...
  expect(stack).to(
    haveResource("AWS::EC2::Subnet", {
      ...
      Tags: [{ Key: "Name", Value: "undifined-undifined-subnet-public-1c" }],
    })
  );
  expect(stack).to(
    haveResource("AWS::EC2::Subnet", {
      ...
      AvailabilityZone: "ap-northeast-1a",
      Tags: [{ Key: "Name", Value: "undifined-undifined-subnet-app-1a" }],
    })
  );
  expect(stack).to(
    haveResource("AWS::EC2::Subnet", {
      ...
      Tags: [{ Key: "Name", Value: "undifined-undifined-subnet-app-1c" }],
    })
  );
  expect(stack).to(
    haveResource("AWS::EC2::Subnet", {
      ...
      AvailabilityZone: "ap-northeast-1a",
      Tags: [{ Key: "Name", Value: "undifined-undifined-subnet-db-1a" }],
    })
  );
  expect(stack).to(
    haveResource("AWS::EC2::Subnet", {
      ...
      AvailabilityZone: "ap-northeast-1c",
      Tags: [{ Key: "Name", Value: "undifined-undifined-subnet-db-1c" }],
    })
  );
});
